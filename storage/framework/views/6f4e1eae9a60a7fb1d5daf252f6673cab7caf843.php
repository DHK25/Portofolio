    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
            ...
            <span class="d-none d-lg-block"><img class="img-fluid img-profile rounded-circle mx-auto mb-2"
                    src="<?php echo e(asset('foto') . '/' . get_meta_value('_foto')); ?>" alt="..." /></span>
        </a>
            ...
            <div class="resume-section-content">
                ...
                <?php $__currentLoopData = $experience; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        ...
                        <div class="flex-shrink-0"><span class="text-primary"><?php echo e($item->tgl_mulai_indo); ?> -
                                <?php echo e($item->tgl_akhir_indo); ?></span></div>
                    </div>
...
<?php /**PATH D:\Semester 7\PKL\Portofolio\resources\views/depan/index.blade.php ENDPATH**/ ?>