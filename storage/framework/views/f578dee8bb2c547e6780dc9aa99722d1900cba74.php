        ...
        <div class="mb-3">
            <div class="row">
                ...
                <div class="col-auto"><input type="date" class="form-control form-control-sm" name="tgl_akhir"
                        placeholder="dd/mm/yyy" value="<?php echo e($data->tgl_akhir); ?>"></div>
            </div>
        </div>
...
<?php echo $__env->make('dashboard.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Semester 7\PKL\Portofolio\resources\views/dashboard/education/edit.blade.php ENDPATH**/ ?>