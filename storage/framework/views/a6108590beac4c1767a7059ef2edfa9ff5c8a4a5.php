    ...
    <form action="<?php echo e(route('experience.store')); ?>" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-sm" name="info1" id="info1"
                aria-describedby="helpId" placeholder="Nama Perusahaan" value="<?php echo e(Session::get('info1')); ?>">
        </div>
        <div class="mb-3">
            <div class="row">
...
<?php echo $__env->make('dashboard.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Semester 7\PKL\Portofolio\resources\views/dashboard/experience/create.blade.php ENDPATH**/ ?>