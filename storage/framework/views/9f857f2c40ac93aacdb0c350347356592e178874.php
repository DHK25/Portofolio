    ...
    <form action="<?php echo e(route('education.store')); ?>" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-sm" name="info1" id="info1"
                aria-describedby="helpId" placeholder="Nama Fakultas" value="<?php echo e(Session::get('info1')); ?>">
        </div>
        <div class="mb-3">
            <label for="info2" class="form-label">Nama Prodi</label>
            <input type="text" class="form-control form-control-sm" name="info2" id="info2"
                aria-describedby="helpId" placeholder="Nama Prodi" value="<?php echo e(Session::get('info2')); ?>">
        </div>
        <div class="mb-3">
            <label for="info3" class="form-label">IPK</label>
            <input type="text" class="form-control form-control-sm" name="info3" id="info3"
                aria-describedby="helpId" placeholder="IPK" value="<?php echo e(Session::get('info3')); ?>">
        </div>
        <div class="mb-3">
            <div class="row">
                ...
                <div class="col-auto"><input type="date" class="form-control form-control-sm" name="tgl_akhir"
                        placeholder="dd/mm/yyy" value="<?php echo e(Session::get('tgl_akhir')); ?>"></div>
            </div>
        </div>
...
<?php echo $__env->make('dashboard.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Semester 7\PKL\Portofolio\resources\views/dashboard/education/create.blade.php ENDPATH**/ ?>